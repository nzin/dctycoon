...
func CreateServerPageBladeWidget(width,height int32) *ServerPageBladeWidget {
	...
	blade1Desc:=sws.CreateTextAreaWidget(150,160,"Simple, efficient but powerfull blade server, this 8U server is pre-equipped with 8 blades, each with 4 slots of RAM")
	...
	blade2Desc:=sws.CreateTextAreaWidget(150,160,"The ultimate 8U solution to all your problems, this pre-equipped 8 blades server has 4 slots of RAM and 2 processors per blade")
